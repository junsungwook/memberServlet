...
<div class="container">
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			<td>아이디</td>
			<td><input type="text" name="id" id="id" disabled="disabled">*<input type="button" value="중복 체크" onclick="window.open('idCheck.jsp','confirm','width=500 height=200')"></td>
		</tr>
		<tr>
			<td>암호</td>
		...
		<tr>
			<td>성별</td>
			<td>
				<input type="radio" name="gender" value="male">남자&emsp;&emsp;&emsp;
